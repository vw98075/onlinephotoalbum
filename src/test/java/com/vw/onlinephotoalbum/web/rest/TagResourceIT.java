...
import com.vw.onlinephotoalbum.repository.TagRepository;
import com.vw.onlinephotoalbum.service.TagService;
...
public class TagResourceIT {
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getCreated()).isEqualTo(DEFAULT_CREATED);
    }
    ...
    public void updateTag() throws Exception {
        ...
        assertThat(testTag.getCreated()).isEqualTo(UPDATED_CREATED);
    }
