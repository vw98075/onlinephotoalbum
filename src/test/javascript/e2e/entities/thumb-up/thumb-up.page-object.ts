...
export default class ThumbUpComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('thumb-up-heading'));
...
export class ThumbUpDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('onlinephotoalbumApp.thumbUp.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-thumbUp'));
}
