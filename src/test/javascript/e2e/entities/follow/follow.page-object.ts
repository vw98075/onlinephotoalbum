...
export default class FollowComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('follow-heading'));
...
export class FollowDeleteDialog {
  ...
  title: ElementFinder = element(by.id('onlinephotoalbumApp.follow.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-follow'));
}
