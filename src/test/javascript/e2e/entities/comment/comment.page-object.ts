...
export default class CommentComponentsPage extends AlertPage {
...
export class CommentDeleteDialog {
  ...
  title: ElementFinder = element(by.id('onlinephotoalbumApp.comment.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-comment'));
}
