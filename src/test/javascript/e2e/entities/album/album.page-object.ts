...
export default class AlbumComponentsPage extends AlertPage {
...
export class AlbumDeleteDialog {
  ...
  title: ElementFinder = element(by.id('onlinephotoalbumApp.album.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-album'));
}
