...
describe('Service Tests', () => {
  describe('Follow Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Follow(0, currentDate, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Follow', async () => {
      ...
      it('should not update a Follow', async () => {
      ...
      it('should not return a list of Follow', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Follow', async () => {
