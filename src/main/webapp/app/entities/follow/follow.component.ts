...
export default class Follow extends mixins(JhiDataUtils, AlertMixin) {
  ...
  public removeFollow(): void {
    this.followService()
      ...
      .then(() => {
        const message = this.$t('onlinephotoalbumApp.follow.deleted', { param: this.removeId });
