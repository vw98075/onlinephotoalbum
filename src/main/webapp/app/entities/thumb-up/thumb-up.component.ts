...
export default class ThumbUp extends mixins(JhiDataUtils, AlertMixin) {
  ...
  public thumbUps: IThumbUp[] = [];

  public isFetching = false;

  public mounted(): void {
    this.retrieveAllThumbUps();
  }
  ...
  public retrieveAllThumbUps(): void {
  ...
  public prepareRemove(instance: IThumbUp): void {
  ...
  public removeThumbUp(): void {
    this.thumbUpService()
      ...
      .then(() => {
        const message = this.$t('onlinephotoalbumApp.thumbUp.deleted', { param: this.removeId });
