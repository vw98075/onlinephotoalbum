package com.vw.onlinephotoalbum.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.vw.onlinephotoalbum.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.vw.onlinephotoalbum.repository.UserRepository.USERS_BY_EMAIL_CACHE);
